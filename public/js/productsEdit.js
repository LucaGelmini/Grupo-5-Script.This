document.addEventListener("DOMContentLoaded", function(){
    ...
    let inputs = document.querySelectorAll('.editar-product-form > input, .editar-product-form > select');
    let submit = document.querySelector('.editar-product-button');
    let form = document.querySelector('.editar-product-form');
